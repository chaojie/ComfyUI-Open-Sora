...
def parse_args(training=False,ckpt_path="",config=""):
...
def parse_configs(training=False,ckpt_path="",config=""):
    args = parse_args(training,ckpt_path=ckpt_path,config=config)
